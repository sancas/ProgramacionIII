...
namespace miEjemplo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string mensaje;
            Console.WriteLine("Escriba un mensaje a cifrar: "); //Se le indiac que necesitamos
            mensaje = Console.ReadLine(); //Se guarda el mensaje
            ...
            string mensajeDescrifrado =
                Encoding.UTF8.GetString(mensajeDesencriptado);
            Console.WriteLine("Esto es el mensaje descifrado: " +
                mensajeDescrifrado);
        ...
        public static byte[] Encriptar(string mensajeSinEncriptar,
            SymmetricAlgorithm algoritmo)
        {
            ...
            CryptoStream cryptoStream = new CryptoStream(memoryStream, encriptador,
